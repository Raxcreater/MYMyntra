  ...
  return (
    <ScrollView>
      <View style={styles.main}>
        <Image
          source={require('./../../Assets/Images/t1.jpeg')}
          style={styles.image}
        />
        <View style={{flexDirection: 'row'}}>
          <Text style={styles.textLable}>UNRl</Text>
          <Text style={styles.lighttextLabl}>
            Men Printed Relaxed Fit Pure Cotton T-shirt
          </Text>
        </View>
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={styles.dicount}>
            <Text style={styles.discoutText}>50% OFF!</Text>
          </View>
        </View>
        <Image
