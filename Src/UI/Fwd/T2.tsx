  ...
  return (
    <ScrollView>
      <View style={styles.main}>
        <Image
          source={require('./../../Assets/Images/t2.jpeg')}
          style={styles.image}
        />
        <View style={{flexDirection: 'row'}}>
          <Text style={styles.textLable}>Bonker Corner</Text>
          <Text style={styles.lighttextLabl}>
            Relaxed Fit Pure Cotton T-shirt
          </Text>
        </View>
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={styles.dicount}>
            <Text style={styles.discoutText}>60% OFF!</Text>
          </View>
        </View>
        <Image
