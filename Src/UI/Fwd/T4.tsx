  ...
  return (
    <ScrollView>
      <View style={styles.main}>
        <Image
          source={require('./../../Assets/Images/t4.jpeg')}
          style={styles.image}
        />
        <View style={{flexDirection: 'row'}}>
          <Text style={styles.textLable}>Bewakoof</Text>
          <Text style={styles.lighttextLabl}>
            Lose Fit Plane Pink Cotton T-shirt
          </Text>
        </View>
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={styles.dicount}>
            <Text style={styles.discoutText}>40% OFF!</Text>
          </View>
        </View>
        <Image
